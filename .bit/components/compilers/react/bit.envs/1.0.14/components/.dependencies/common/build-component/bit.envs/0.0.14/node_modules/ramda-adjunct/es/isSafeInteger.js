...
export var isSafeIntegerPolyfill = curry1(polyfill);
/**
...
var isSafeInteger = isFunction(Number.isSafeInteger) ? curry1(bind(Number.isSafeInteger, Number)) : isSafeIntegerPolyfill;
