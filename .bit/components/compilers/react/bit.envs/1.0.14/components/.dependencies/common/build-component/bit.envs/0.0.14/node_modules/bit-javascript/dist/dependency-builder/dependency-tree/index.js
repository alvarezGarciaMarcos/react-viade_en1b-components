...
const precinct = require('../precinct'); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!


const cabinet = require('../filing-cabinet'); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
