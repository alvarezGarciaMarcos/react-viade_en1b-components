...
function toFiles(versionModel) {
  ...
  if (versionModel.impl) {
    ...
    versionModel.files.push(file); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  ...
  if (versionModel.dist) {
    ...
    versionModel.dists.push(file); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
